      ...
      try {
        ...
        for (let i = 1; i < sections.length; i++) {
          ...
          allOrders.push({
            ...
            status: tabName,
            platform: '\u6296\u97f3',
            sellerFlag: cardInfo.sellerFlag || 0,
            systemFlag: cardInfo.systemFlag || 0,
            sellerFlagColor: cardInfo.sellerFlagColor || 'rgb(170, 170, 170)',
            systemFlagColor: cardInfo.systemFlagColor || 'rgb(170, 170, 170)'
          });
        }
